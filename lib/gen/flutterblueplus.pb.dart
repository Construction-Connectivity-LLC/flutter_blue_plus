...
class ScanError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScanError', createEmptyInstance: create)
  ...
  factory ScanError.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ScanError.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ScanError clone() => ScanError()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ScanError copyWith(void Function(ScanError) updates) => super.copyWith((message) => updates(message as ScanError)) as ScanError; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ScanError create() => ScanError._();
  ScanError createEmptyInstance() => create();
  static $pb.PbList<ScanError> createRepeated() => $pb.PbList<ScanError>();
  @$core.pragma('dart2js:noInline')
  static ScanError getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ScanError>(create);
  static ScanError? _defaultInstance;
