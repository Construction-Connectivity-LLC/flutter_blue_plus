            ...
            switch (call.method) {
               ...
               case "getAdapterName":
                ...
                case "startScan":
                {
                    ...
                    List<Integer> withManufacturerIds =    (List<Integer>) data.get("manufacturer_ids");
                    ...
                    ensurePermissions(permissions, (granted, perm) -> {
                        ...
                        //manufacturer id
                        for (int i = 0; i < withManufacturerIds.size(); i++) {
                            int manufacturerId = withManufacturerIds.get(i);
